// We simply need to run this for all possible assignments and if the assignment is valid we count the number of ones. 
// At the end we return the maximum number of ones out of all valid assignments.
